...
fun BusinessCard() {
    Column(
        modifier = Modifier
            .fillMaxHeight()
            .fillMaxWidth()
            .background(color = Color(0xFF032F30))
        ,
    ...
    Column(
        ...
        Row(
            ...
            Icon(painter = icon, contentDescription = null, modifier = Modifier.padding(start = 40.dp), Color(0xFF3ddc84)
            )
        ...
        Row(
            ...
            Icon(painter = icon2, contentDescription = null,  modifier = Modifier.padding(start = 40.dp),Color(0xFF3ddc84))
        ...
        Row(
            ...
            Icon(painter = icon3, contentDescription = null, modifier = Modifier.padding(start =40.dp),Color(0xFF3ddc84) )
